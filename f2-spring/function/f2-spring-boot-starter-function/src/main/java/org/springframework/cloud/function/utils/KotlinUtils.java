	...
	public static boolean isKotlinType(Object object) {
		if (KotlinDetector.isKotlinPresent()) {
			return KotlinDetector.isKotlinType(object.getClass()) || object instanceof Function0<?>
					...
					// KOMUNE Modification: F2 functional interfaces are no longer suspend function types,
					// so their SAM conversions may be compiled as invokedynamic proxies without Kotlin @Metadata.
					|| object instanceof f2.dsl.fnc.F2Function<?, ?>
					|| object instanceof f2.dsl.fnc.F2Supplier<?>;
